...
public class ConfigurationDialog extends JDialog {
	...
	private static java.util.List<String> configurationPanelsClassNames=new java.util.ArrayList<String>();
	...
	private void init(){
		...
		addAditionalConfigurationPanels();
	}
	
	private void addAditionalConfigurationPanels() {
		for(String panelClass:configurationPanelsClassNames)
		{
			try{
				Class<?> confPanelClass=Class.forName(panelClass, true, JFMClassLoader.getLoader());
				ConfigurationPanel panel=(ConfigurationPanel)confPanelClass.newInstance();
				mainPanel.addConfigurationPanel(panel);
			}catch(Exception exc){
				exc.printStackTrace();
			}
		}
	...
	public static java.util.List<String> getConfigurationPanelsClassNames()
	{
		return configurationPanelsClassNames;
	}
}
