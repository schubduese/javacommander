...
public class ConfigurationDialogPanel extends JPanel {
	...
	private ConfigurationTreeNode pluginsNode=null;
	...
	private void setupTree(){
		...
		ConfigurationPanel plugins=new ConfigurationPanel("Plugins","Plugins settings");
		pluginsNode=new ConfigurationTreeNode(plugins);
	...
	public void addConfigurationPanel(ConfigurationPanel panel)
	{
		ConfigurationTreeNode panelNode=new ConfigurationTreeNode(panel);
		pluginsNode.add(panelNode);
	}
