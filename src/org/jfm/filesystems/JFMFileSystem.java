...
public abstract class JFMFileSystem {
  ...
  private static void registerFilesystem(File f) throws ParserConfigurationException,SAXException,IOException{
	...
	if(handler.getConfPanelClass()!=null)
	{
		ConfigurationDialog.getConfigurationPanelsClassNames().add(handler.getConfPanelClass());
	}
    ...
    public abstract void disposeFilesystem();
