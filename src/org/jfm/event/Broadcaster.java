...
public class Broadcaster
{
  ...
  /**Adds a listener who listens for the FontChangeEvent*/
  public static void addFSPluginOptionChangedListener(FSPluginOptionsChangedListener listener)
  {
    addListener(FSPluginOptionsChangedListener.class, listener);
  }

  /**Removes a listener who listens for the FontChangeEvent*/
  public static void removeFSPluginOptionChangedListener(FSPluginOptionsChangedListener listener)
  {
    removeListener(FSPluginOptionsChangedListener.class, listener);
  }

  /**Notifies all listeners who listens for the FontChangeEvent*/
  public static void notifyFSPluginOptionChangedListeners(FSPluginOptionsChangedEvent event)
  {
    Iterator it = getListenerIterator(FSPluginOptionsChangedListener.class);
    FSPluginOptionsChangedListener listener;
    while(it.hasNext())
    {
      listener = (FSPluginOptionsChangedListener)it.next();
      listener.setOptions(event);
    }
  }
