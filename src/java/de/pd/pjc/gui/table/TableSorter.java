...
public class TableSorter extends AbstractTableModel {
	...
	final static Log mLog = LogFactory.getLog(TableSorter.class.getName());
	...
	private class Row implements Comparable {
		...
		public int compareTo(Object o) {
			...
			for (Iterator it = sortingColumns.iterator(); it.hasNext();) {
				...
				FileElement fileElement1 = (FileElement) tableModel.getValueAt(
						row1, Constants.COLUMN_NAME);
				;
				FileElement fileElement2 = (FileElement) tableModel.getValueAt(
						row2, Constants.COLUMN_NAME);
				;
...
//				if (column == Constants.COLUMN_NAME
//						&& directive.direction == ASCENDING) {
//					return fileElement1.getFileName().compareTo(
//							fileElement2.getFileName());
//				} else if (column == Constants.COLUMN_NAME
//						&& directive.direction == DESCENDING) {
//					return fileElement2.getFileName().compareTo(
//							fileElement1.getFileName());
//				}
	...
	private class MouseHandler extends MouseAdapter {
		public void mouseClicked(MouseEvent e) {
			...
			if (column != -1) {
				...
				if(!h.getTable().getName().equals(FileTablePanel.SEARCH_FILE_TABLE)) {
					MainWindowWrapper.sortChanged(column, status);
				}
			}
		}
	}
	...
	public void resetSorting() {
		...
		for (int ii = 0; ii < columnCount; ii++) {
			setSortingStatus(ii, NOT_SORTED);
		}
	}
}
